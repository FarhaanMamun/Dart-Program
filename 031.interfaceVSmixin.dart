...
class Base1 
{
  ...
  void printV() 
  {
    print('In class Base1 -> varInbase1 = $varInbase1, var2Inbase1 = $var2Inbase1');
  }
}
...
class InterfaceOfBase implements Base1, Base2 
{
  ...
  InterfaceOfBase(this.valInInterfaceOfBase, this.varInbase1, this.var2Inbase1,this.varInbase2);
  ...
  void printV() 
  {
    print('''In class InterfaceOfBase ->(Overridden from Base1 & Base2) 
     varInbase1 = $varInbase1, var2Inbase1 = $var2Inbase1, varInbase2 = $varInbase2
...
void main() 
{
  ...
  withMixin_interface.info(); // Function definition overridden from mix1, cause it was at the last in class definition
