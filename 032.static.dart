...
abstract class Animal 
{
  ...
  void info() 
  {
    print("${this.runtimeType} has $legs legs. Total animal created ${Animal.countAnimal}");
  }
}
...
void main() 
{
  print("Number of Animal objects = countInstance() -> ${Animal.countInstance()}, countAnimal = ${Animal.countAnimal}");
  ...
  rocky.info();
  print("Number of Animal objects = countInstance() -> ${Animal.countInstance()}, countAnimal = ${Animal.countAnimal}");
  print("Number of Horse objects = ${Horse.countHorse}\nNumber of Dove objects = ${Dove.countDove}");
}